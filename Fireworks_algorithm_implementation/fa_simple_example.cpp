...
const ll T = 2;			// number of iterations
const ll n = 3;			// number of locations (fireworks)
const ll d = 2;				// dimensionality
const ll m = 3;			// number of sparks with normal explosion
const ll mh = 2;			// number of sparks with Gaussian explosion
const dbl Ah = 10;			// maximum explosion amplitude
const dbl a = 0;		
const dbl b = 0.8;
const vdd bounds = { dd(0, 20), dd(0, 20) };	// Limits for d dimensions

// function d dimensions
dbl f(vd &v) { return (v[0]+1)- v[1]; }
